...
const Home = () => {
  ...
  <Carousel.Item>
    <img
      ...
      src="https://images.pexels.com/photos/1720186/pexels-photo-1720186.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
      alt="First slide"
    />
    <Carousel.Caption>
  ...
  <Carousel.Item>
    <img
      className="d-block w-100 hero-img"
      src="https://images.pexels.com/photos/5428148/pexels-photo-5428148.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
      alt="Second slide"
    />
  ...
  <Carousel.Item>
    <img
      className="d-block w-100 hero-img"
      src="https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
      alt="Third slide"
    />
      ...
      <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
            ...
            <Row xs={1} md={3} className="g-4 m-3">
                ...
                <Card>
                    ...
                    <Card.Text>
                    Better designed programs for you Online Availability to sources Helping Board in your learning management
                    </Card.Text>
            ...
            <Row xs={1} md={2} className="g-4 m-3">
                <Col>
                <Card>
                    <Card.Img variant="top" src="https://www.webfulcreations.com/themes/education/wp-content/uploads/sites/2/2016/11/education_bg.jpg" />
                ...
                <Card className = ''>
                    <Card.Body>
                    <h2>WELCOME TO <span className = 'text-warning'>WEBFUL EDUCATION!</span></h2>
